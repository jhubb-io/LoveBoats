...
if ( ! class_exists('Reea_Register_Post_Type') ) {
    class Reea_Register_Post_Type {
        private $post_type;
        private $post_slug;
        private $args;
        ...
        public function __construct( $post_type = null, $args = array(), $custom_plural = false ) {
            ...
            //conditioned for testimonial so we can use testimonials slug page as archive page without re-writing url's and conditoinaning specific urls for specifc pages
            $this->post_type = $post_type;
            $this->post_slug = ( $custom_plural ) ? $custom_plural : ( ( $post_type === 'testimonial' ) ? $post_type : $post_type . 's' ); 
    ...
    if ( ! function_exists( 'Reea_Register_Post_Type' ) && class_exists( 'Reea_Register_Post_Type' ) ) {
        function Reea_Register_Post_Type( $post_type = null, $args=array(), $custom_plural = false ) {
            $custom_post = new Reea_Register_Post_Type( $post_type, $args, $custom_plural );
        }
    }
}
...
Reea_Register_Post_Type( 'boat', $submuitArgs );
